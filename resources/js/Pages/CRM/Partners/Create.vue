...
const submit = () => {
  form.post(route('crm.partners.store'));
};
</script>
    ...
    <v-row justify="center">
      <v-col cols="12" md="10" lg="8">
        <div class="mb-6 d-flex align-center">
          ...
          <h2 class="text-h4 font-weight-bold">Add New Partner</h2>
        </div>
          ...
          <form @submit.prevent="submit">
            <v-row>
              ...
              <v-col cols="12" class="d-flex justify-end gap-2">
                <Link :href="route('crm.partners.index')" class="text-decoration-none mr-2">
