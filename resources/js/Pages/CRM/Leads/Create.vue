    ...
    <v-row>
      <v-col cols="12" class="mb-0">
        <div class="d-flex align-center text-caption text-medium-emphasis mb-2">
          ...
          <v-icon size="14" class="mx-1">mdi-chevron-right</v-icon>
          <span class="text-high-emphasis">New Lead</span>
        </div>
        <h2 class="text-h3 font-weight-bold mb-6">New Lead</h2>
      </v-col>

      <v-col cols="12" md="8">
        <v-card elevation="0" border>
          <v-card-title class="pa-4 border-bottom">
            <span class="text-h6 font-weight-bold">Lead Information</span>
          </v-card-title>
